        ...
        <section id="entry-requirements" className="mb-16 scroll-mt-32">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <ul className="list-disc pl-5 space-y-3 mb-6">
              ...
              <li>Strong background in mathematics and social sciences</li>
            ...
            <ol className="list-decimal pl-5 space-y-3">
              ...
              <li>Attend an entrance examination (mathematics, economics, and logical reasoning)</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col items-center mb-4">
                ...
                <h3 className="text-lg font-semibold">Prof. Amina Ahmed, PhD</h3>
                <p className="text-sm text-gray-600">Department Chair</p>
              </div>
              <p className="text-sm text-center">Specialization in Economics and Finance</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col items-center mb-4">
                <div className="w-24 h-24 rounded-full bg-gray-200 mb-4"></div>
              ...
              <p className="text-sm text-center">Specialization in Marketing and Management</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col items-center mb-4">
                <div className="w-24 h-24 rounded-full bg-gray-200 mb-4"></div>
              ...
              <p className="text-sm text-center">Specialization in Human Resource Management</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col items-center mb-4">
                <div className="w-24 h-24 rounded-full bg-gray-200 mb-4"></div>
              ...
              <p className="text-sm text-center">Specialization in International Business</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col items-center mb-4">
                <div className="w-24 h-24 rounded-full bg-gray-200 mb-4"></div>
              ...
              <p className="text-sm text-center">Specialization in Entrepreneurship</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col items-center mb-4">
                <div className="w-24 h-24 rounded-full bg-gray-200 mb-4"></div>
              ...
              <p className="text-sm text-center">Specialization in Public Administration</p>
            </div>
          </div>
        </section>
