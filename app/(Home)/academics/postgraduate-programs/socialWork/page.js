...
export default function SocialWorkPage() {
  ...
  return (
    <div className="min-h-screen bg-white py-8 mt-20">
      <div className="bg-gradient-to-r from-[#5b21b6] to-[#4c1d95] py-16 px-4 sm:px-6 lg:px-8 text-white">
        ...
        <div className="max-w-7xl mx-auto overflow-x-auto">
          <div className="flex whitespace-nowrap py-2 px-4">
            <button
              ...
              className="bg-[#5b21b6] text-white border border-[#5b21b6] font-medium py-2 px-6 rounded-md mr-2 hover:bg-[#4c1d95] transition-all"
            >
              Overview
            </button>
            <button
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <section id="overview" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#5b21b6]">PROGRAM OVERVIEW</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4 text-[#5b21b6]">Program Options</h3>
        ...
        <section id="specializations" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#5b21b6]">AREAS OF SPECIALIZATION</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="h-12 w-12 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#5b21b6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2 text-[#5b21b6]">Clinical Social Work</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#5b21b6]">Community Practice & Social Development</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#5b21b6]">Child, Youth & Family Services</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#5b21b6]">Health & Mental Health</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#5b21b6]">Global Social Work</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#5b21b6]">Aging & Gerontology</h3>
              <p className="text-sm text-gray-700 mb-4">
        ...
        <section id="fieldwork" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#5b21b6]">FIELD EDUCATION</h2>
          <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-lg border border-purple-100 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4 text-[#5b21b6]">Field Placement Settings</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-4 text-[#5b21b6]">Field Education Structure</h3>
        ...
        <section id="curriculum" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#5b21b6]">CURRICULUM</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-3 text-[#5b21b6]">Foundation Courses</h3>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-[#5b21b6] mr-2 font-bold">•</span>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-3 text-[#5b21b6]">Advanced Courses</h3>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-[#5b21b6] mr-2 font-bold">•</span>
        ...
        <section id="admissions" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#5b21b6]">ADMISSIONS</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-purple-50 rounded-lg">
                <h4 className="font-medium text-[#5b21b6] mb-2">Advanced Standing Eligibility</h4>
                <p className="text-sm">
              ...
              <table className="min-w-full">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-2">$38,400 (traditional) / $23,040 (advanced)</td>
                  </tr>
                  <tr>
        ...
        <div className="bg-gradient-to-r from-[#5b21b6] to-[#4c1d95] p-8 rounded-lg text-white text-center">
          ...
          <Link href="/admissions/apply" className="inline-block bg-white text-[#5b21b6] font-medium py-3 px-8 rounded-md hover:bg-gray-100 transition-colors">
            Apply Now
          </Link>
        </div>
      </div>
