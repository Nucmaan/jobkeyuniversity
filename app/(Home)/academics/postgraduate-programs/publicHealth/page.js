    ...
    <div className="min-h-screen bg-white py-8 mt-20">
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <section id="concentrations" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#33d1ff]">AREAS OF CONCENTRATION</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#33d1ff]">Epidemiology</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#33d1ff]">Global Health</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#33d1ff]">Health Policy & Management</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#33d1ff]">Community Health</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#33d1ff]">Environmental Health</h3>
              <p className="text-sm text-gray-700 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#33d1ff]">Health Informatics</h3>
              <p className="text-sm text-gray-700 mb-4">
        ...
        <section id="curriculum" className="mb-16 scroll-mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-3 text-[#33d1ff]">Core Courses (24 Credits)</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-3 text-[#33d1ff]">Program Structure (45 Credits)</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <span className="font-bold text-[#33d1ff]">24</span>
                  </div>
                  <div>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <span className="font-bold text-[#33d1ff]">12</span>
                  </div>
                  <div>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <span className="font-bold text-[#33d1ff]">6</span>
                  </div>
                  <div>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <span className="font-bold text-[#33d1ff]">3</span>
                  </div>
                  <div>
        ...
        <section id="practice" className="mb-16 scroll-mt-32">
          <h2 className="text-3xl font-bold mb-6 text-[#33d1ff]">APPLIED PRACTICE EXPERIENCE</h2>
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-4 text-[#33d1ff]">Practice Settings</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-[#33d1ff] mr-2 mt-1">•</span>
                    <div>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4 text-[#33d1ff]">Recent Practice Projects</h3>
                <div className="space-y-4">
